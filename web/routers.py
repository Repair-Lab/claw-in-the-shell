"""
web/routers.py — Alle API-Routen (Phase 2)
==========================================
377 Routen, extrahiert aus web/server.py.
Jede Route nutzt @app.get/post/patch/delete/put/websocket.
...
# ── /api/llm/models/{model_id}/activate ──
...
# ── /api/llm/models/{model_id}/deactivate ──
...
# ── /api/llm/models/{model_id}/benchmark ──
...
# ── /api/llm/models/{model_id}/auto-config ──
...
# ── /api/llm/fallback-chain/{chain_id} ──
...
# ── /api/agents/instances/{instance_id} ──
...
# ── /api/agents/instances/{instance_id}/start ──
...
# ── /api/agents/instances/{instance_id}/stop ──
...
# ── /api/agents/scheduled-jobs/{job_id} ──
...
# ── /api/sql-explorer/tables/{schema} ──
...
# ── /api/sql-explorer/rows/{schema}/{table} ──
...
# ── /api/llm/providers/{provider_key} ──
...
# ── /api/llm/providers/{provider_key}/test ──
...
# ── /api/llm/providers/{provider_key}/key ──
...
# ── /api/settings/linux/{category}/action ──
...
# ── /api/network/devices/{device_id}/add-to-desktop ──
...
# ── /api/learning/system-prompt-context ──
...
# ── /api/workshop/projects/{project_id} ──
...
# ── /api/workshop/projects/{project_id}/media ──
...
# ── /api/workshop/projects/{project_id}/collections ──
...
# ── /api/workshop/projects/{project_id}/devices ──
...
# ── /api/workshop/projects/{project_id}/imports ──
...
# ── /api/workshop/projects/{project_id}/chat ──
...
# ── /api/synaptic/memories/{memory_id} ──
...
# ── /api/immutable/snapshots/{snapshot_id} ──
...
# ── /api/immutable/snapshots/{snapshot_id}/restore ──
...
# ── /api/anomaly/detections/{detection_id}/resolve ──
...
# ── /api/security/vulnerabilities/{vuln_id}/mitigate ──
...
# ── /api/security/dns-sinkhole/{rule_id} ──
...
# ── /api/security/rate-limits/{limit_id} ──
...
# ── /api/workshop/projects/{project_id}/custom-tables ──
...
# ── /api/workshop/projects/{project_id}/custom-tables/{table_id} ──
...
# ── /api/workshop/projects/{project_id}/custom-tables/{table_id}/rows ──
...
# ── /api/workshop/projects/{project_id}/custom-tables/{table_id}/rows/{row_id} ──
...
# ── /api/ghost-browser/tasks/{task_id} ──
...
# ── /api/ghost-browser/tasks/{task_id}/steps ──
...
# ── /api/ghost-browser/tasks/{task_id}/run ──
...
# ── /api/ghost-browser/tasks/{task_id}/cancel ──
...
# ── /api/ghost-browser/results/{task_id} ──
...
# ── /api/ghost-browser/screenshots/{task_id}/{step} ──
...
# ── /api/mobile-bridge/devices/register ──
...
# ── /api/mobile-bridge/sensors/pipeline ──
...
# ── /api/mobile-bridge/hardware-profiles ──
...
# ── /api/autonomous/migrations/{migration_id} ──
...
# ── /api/gpu/split-configs/{config_id}/activate ──
...
# ── /api/gpu/sync-events/{session_id} ──
...
# ── /api/cluster/nodes/{node_id}/heartbeat ──
...
# ── /api/marketplace/{catalog_id}/download ──
...
# ── /api/marketplace/downloads/queue ──
...
# ── /api/marketplace/downloads/{download_id} ──
...
# ── /api/marketplace/{catalog_id}/review ──
