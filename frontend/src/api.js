...
export const api = {
  ...
  askGhost: (role, question, context = {}, model = null, images = []) =>
    request('/ghosts/ask', { method: 'POST', body: JSON.stringify({ role, question, context, ...(model ? { model } : {}), ...(images.length ? { images } : {}) }) }),
